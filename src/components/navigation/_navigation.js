...
import {Menu,SubMenu} from './_style';
...
const Navigaition = ({ page, ...props }) => {
	...
	const onMouseEnterHandler = () => {
		...
		tl.to(".menu li a", 0.1, { //글자색 바꾸고
			color:"black",
		  }).to(".submenu", 0.1, { //메뉴 내리기
			top:'-3vh',
			opacity:1,
			ease:Sine.easeOut
		  }).play();
	...
	return (
		<div className="navigation" onMouseEnter={onMouseEnterHandler} onMouseLeave={onMouseLeaveHandler}>
			<div>
			<Menu className="menu">
				<li onMouseEnter={hoverMenu1_enter} className={state.isActive1 ? "active" : ""} >
					<a href="#" >Company</a>
				</li>
				<li onMouseEnter={hoverMenu2_enter} className={state.isActive2 ? "active" : ""}>
					<a href="#" >Future</a>
				</li>
				<li onMouseEnter={hoverMenu3_enter} className={state.isActive3 ? "active" : ""}>
					<a href="#" >Business</a>
				</li>
				<li onMouseEnter={hoverMenu4_enter} className={state.isActive4 ? "active" : ""}>
					<a href="#" >Products</a>
				</li>
				<li onMouseEnter={hoverMenu5_enter} className={state.isActive5 ? "active" : ""}>
					<a href="#" >Service</a>
				</li>
			</Menu>
			</div>
